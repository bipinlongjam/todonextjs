        ...
        <div className="sm:w-9/12 lg:w-6/12 w-full px-4 lg:my-10 flex flex-col justify-center items-center">
          ...
          {editTodo ? (
            ...
            <>
              ...
              />
              <button onClick={addTodo} className="bg-slate-800 px-6 py-2 rounded-lg my-7 text-green-400 text-lg uppercase font-semibold">Add</button>
            </>
          )}
        </div>
        <ul className="sm:w-9/12 lg:w-5/12 w-full px-4flex flex-col justify-center items-center my-6 py-6">
          {isLoading && (<p className="text-green-600 text-2xl italic my-10">Loading....</p>
          )}
          {!isLoading && todos && todos.length == 0 ? (
            <div className="text-green-600 text-2xl italic my-10">
